...
{
    Scalar HOT_PINK = new Scalar(0,0,0);

    // Pink, the default color                         Y      Cr     Cb    (Do not change Y)
    public static Scalar scalarLowerYCrCb = new Scalar(  0.0, 104.0, 120.0);
    public static Scalar scalarUpperYCrCb = new Scalar(255.0, 121.0, 172.0);
